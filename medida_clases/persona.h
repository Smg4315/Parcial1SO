...
private:
    ...
    char calendario;              // Calendario de declaración (A/B/C)
...
public:
    ...
    Persona(std::string nom, std::string ape, std::string id, 
            std::string ciudad, std::string residencia, std::string fecha, double ingresos, 
            double patri, double deud, bool declara, char calendario);
    ...
    char getCalendario() const { return calendario; }
