...
Persona generarPersona() {
    ...
    std::string residencia = ciudadesColombia[rand() % ciudadesColombia.size()];
    ...
    char calendario = asignarCalendario(id);

    return Persona(nombre, apellido, id, ciudad, residencia, fecha, ingresos, patrimonio, deudas, declarante, calendario);
}
